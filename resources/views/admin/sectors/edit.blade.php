...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <h6 class="mb-0 text-uppercase">Sector & Company Edit</h6>
            <hr>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea type="text"
                                              ...
                                              name="description_en"
                                              rows="3">{!! $item->description ?? old('description_en') !!}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text"
                                              ...
                                              name="description_ar"
                                              rows="3">{!! $item->translate('ar')->description ?? old('description_ar') !!}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text"
                                              ...
                                              name="content_ar"
                                              rows="7">{!! $item->translate('ar')->content ?? old('content_ar') !!}</textarea>
                                    @error('content_ar')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{$item->sort}}" name="sort" min="0">
                                    @error('sort')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{$item->link ?? old('link')}}" name="link">
                                    @error('link')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        @forelse ( $parents as $parent )
                                            @if($parent->id !== $item->id )
                                                <option value="{{$parent->id}}"
                                                        @if($item->parent_id == $parent->id) selected @endif>{{$parent->title}}</option>
                                            @endif
                                        @empty
                                        @endforelse
                                    </select>
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input {{ $errors->has('is_active') ? ' is-invalid' : '' }}"
                                           value="1" type="checkbox" id="flexSwitchCheckChecked"
                                           @if($item->is_active == 1) checked @endif  name="is_active">
