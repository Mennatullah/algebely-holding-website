                ...
                <div
                    ...
                    <div class="card rounded-0 m-3 mb-0 border-0 shadow-none bg-none">
                        <div class="card-body p-sm-5">
                            <img src="{{ URL::asset('assets/images/logo.svg') }}" class="mb-4" width="145"
                                alt="">
                            <h4 class="fw-bold">Algebely Holding Admin Portal</h4>
{{--                            <h4 class="fw-bold">Get Started Now</h4>--}}
                            <p class="mb-0">Get Started Now Enter your credentials to login your account</p>
                                ...
                                <form method="POST" action="{{ route('login') }}" class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            id="email" placeholder="jhon@example.com" value="{{ old('email') }}" name="email"
